...
Lean se trata de un demostrador interactivo de problemas mediante el cual se
pueden formalizar multitud de resultados. Existen otros demostradores
interactivos muy conocidos como es Isabelle/HOL que ha sido usado en alguna
asignatura del Máster en Lógica, Computación e Inteligencia Artificial de la
Universidad de Sevilla.

El demostrador interactivo Lean es relativamente joven pues fue desarrollado
en 2013 por Microsoft Research. Asimismo, existen diversas versiones de Lean,
en concreto en el trabajo ha sido utilizada la versión 3.28.00.

En este trabajo se ha usado Lean con el objetivo de formalizar diferentes
problemas correspondientes a las Olimpiadas Internacionales de Matemáticas
(IMO).

Las IMO consisten en una competición de matemáticas que se realiza anualmente
para estudiantes preuniversitarios. La competición consta de dos cuestionarios
con tres problemas cada uno, formando un total de seis. Los problemas que aquí
se proponen suelen ser de diversas áreas de las matemáticas: álgebra, análisis,
geometría, teoría de números...

Para la formalización de los diversos problemas que se han estudiado en el
...
\href{https://leanprover-community.github.io/lftcm2020/}
     ...
     \comentario{He añadido a la bibliografía la cita del vídeo según las
       indicaciones que me dió, pero no estoy del todo segura.}

     \comentario{En la última corrección usted me añadió la cita del congreso,
     aunque no entiendo muy bien ahí como está introducida.}
