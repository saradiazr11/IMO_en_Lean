...
faltan por demostrar (\(p\) primo y (\ref{h2intro})), veamos las pruebas
que nos han demostrado los cuatro resultados anteriores.
...
⊢ prime (min_fac m)
    ...
    \tactica{suggest}{suggest} y se obtiene varias prupuestas, de la que
