...
versiones de mathlib. Estos problemas son bastante comunes cuando se trabaja
...
\item \textbf{Demostración y formalización del hecho hp}
  ...
  A continuación, se demostrará el hecho (\ref{hpintro2}) bajo las hipótesis
...
(\ref{hpintro2}) ya se tendría completada la prueba de que existen infinitos
...
demostraciones de algunos hechos; en concreto, los hechos (\ref{hpintro2}) y
...
En el caso del hecho (\ref{hpintro2}) la propuesta que nos hace Lean no es óptima
