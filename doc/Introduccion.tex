...
Como consecuencia de todo esto, actualmente se están desarrollando multitud de
...
El siguiente capítulo es el más extenso del trabajo y es en el que se detallan
...
\comentario{Las citas challenge y tactic no sé si se corresponden al año 2019.}
\comentario{La cita challenge no sé si está correcta}
\comentario{En la cita mini en los apartados de autor e institución no sé qué
  poner}
\comentario{La parte del Apéndice A no sé si está bien comentada ahí o no pero
no se me ocurre dónde introducirlo (alomejor no es necesario).}
%%% Local Variables:
%%% mode: latex
