...
Este problema ha sido probablemente el más laborioso del trabajo: ha sido
...
Una vez ya se ha demostrado en qué dos casos se verifica la expresión para
...
Finalmente, para concluir el problema que deseamos basta con aplicar el teorema
...
\comentario{Se confunden las referencias a las ecuaciones y a los diferentes
capítulos}

\comentario{Quedaría mejor una distinción de secciones. Por ejemplo cuando decimos "Todos estos capítulos que se han desarrollado previamente..." no sé si está
muy seguido de la conclusión de los problemas}
