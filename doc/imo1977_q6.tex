...
\comentario{Comentar el significado de N⁺}
...
\begin{demostracion}
  ...
  En primer lugar, fijemos un número natural positivo arbitrario \(n\). A
  continuación, se hace uso del teorema \ref{extension}, el cual está
  definido sobre el conjunto de los números naturales. Aplicamos este
  teorema sobre una función que está definida sobre el conjunto de los
  número naturales, de manera que si consideramos un número \(m\) natural
