...
\comentario{Usando condicionales en lugar de hipótesis se escriben en
  una línea. Para usar varias líneas se usa el entorno leancode en lugar
  de la orden mint.}
...
\comentario{Misms solución que en el anterior lema}
...
\comentario{Misma solución que en los anteriores.}
