...
\begin{itemize}
\item \mint{lean}|eq_of_abs_sub_nonpos (h : abs (a - b) ≤ 0) : a = b |
  \indLema{eq\_of\_abs\_sub\_nonpos}
\item \mint{lean}|abs_add (a b : α) : abs (a + b) ≤ abs a + abs b|
  \indLema{abs\_add}
\item \mint{lean}|abs_sub (a b : α) : abs (a - b) = abs (b - a)|
  \indLema{abs\_sub}
\item \mint{lean}|le_max_left (a b : α) : a ≤ max a b|
  \indLema{le\_max\_left}
\item \mint{lean}|le_max_right (a b : α) : b ≤ max a b|
...
Al igual que en el resultado anterior, para la formalización del que acabamos
...
{data.real.basic} para poder trabajar con los números reales.

Para la formalización de este resultado se han usado los dos siguientes lemas
auxiliares:
...
En el caso de este resultado, se ha importado  librería \href{https://github.com/leanprover-community/mathlib/blob/master/src/data/real/basic.lean}
  {data.real.basic}, para trabajar con el conjunto de los números reales.

En este caso, para la formalización del resultado sólo se ha usado el siguiente
lema auxiliar:
...
Asimismo, ha sido necesario importar la librería \href{https://github.com/leanprover-community/mathlib/blob/master/src/data/real/basic.lean}{data.real.basic}
para trabajar con el conjunto de los números reales.
...
Asimismo, aparte de la táctica \tactica{ring}{ring}, ha sido necesario el uso
de las tácticas
\tactica{cases}{cases},
