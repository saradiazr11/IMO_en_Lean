...
\comentario{Se debe de aproximar lo máximo posible la escritura en
  lenguaje natural y en LaTeX. En el caso de la definición anterior se
  usa \(a\) para el límite pero en su formalizaciónse cambia por
  \(c\). Se debe de poner las dos veces el mismo símbolo.}
...
\begin{demostracion}
  ...
  \comentario{He cambiado la forma de escribir max .}
...
\begin{demostracion}
  ...
  \comentario{No usar tabuladores como estaban en la siguiente
    matriz. Se pueden eliminar con untabify y se puede evitar su
    escritura poniendo (setq-default indent-tabs-mode nil) en el fichero
...
\comentario{Escribir dos espacios al inicio de cada línea de los bloques
  begin/end. Lo he corregido en el bloque anterior.}
...
\begin{demostracion}
  ...
  \comentario{He cambiado equations por align.}
...
\comentario{En las definiciones cambiar underline por textbf.}
...
\comentario{Importar sólo las teorías necesarias. En la prueba anterior,
  ¿las dos importaciones son necesarias?}
...
\comentario{Revisar la definición de divisibilidad para que se
  corresponda el orden de los factores con la de Lean.}
