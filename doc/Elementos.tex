...
\comentario{En este caso creo que ambas teorías son necesarias. La primera
  de ellas porque las funciones usadas están definidas en el conjunto de
  los números reales y la segunda para que la suma de funciones esté bien
  definida.}

\comentario{Lo he probado y la segunda no es necesaria. Puede que
  tengamos distintas versiones de Lean. La que estoy usando es la 3.24.0
  y la versión de mathlib es la 44fd23d139bdb8cf3680c4a481e8035468e1d390
  como se indica en el fichero leanpkg.toml.}
