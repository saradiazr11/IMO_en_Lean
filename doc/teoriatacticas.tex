...
\comentario{En la bibliografía he puesto el tutorial pero no sé qué autor poner}
...
\item Cuando se tiene una hipótesis que afirma que existe un número tal que
  verifica una determinada considción, se usa la táctica \tactica{cases}{cases}
...
Veámos un ejemplo del uso de la táctica \tactica{from}{from} para probar una
...
La táctica \tactica{norm_num}{norm\_num} es capaz de probar de manera directa
...
lo hace la táctica \tactica{exact}{exact}; no obstante, en esta nueva táctica se
